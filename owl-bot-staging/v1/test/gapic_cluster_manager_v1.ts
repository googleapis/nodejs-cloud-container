...
describe('v1.ClusterManagerClient', () => {
    ...
    describe('updateNodePool', () => {
        it('invokes updateNodePool without error', async () => {
            ...
            request.clusterId = '';
            request.nodePoolId = '';
            const expectedHeaderRequestParams = "name=&project_id=&zone=&cluster_id=&node_pool_id=";
            const expectedOptions = {
                otherArgs: {
                    headers: {
                        'x-goog-request-params': expectedHeaderRequestParams,
    ...
    describe('getOperation', () => {
        it('invokes getOperation without error', async () => {
            ...
            request.zone = '';
            request.operationId = '';
            const expectedHeaderRequestParams = "name=&project_id=&zone=&operation_id=";
            const expectedOptions = {
                otherArgs: {
                    headers: {
                        'x-goog-request-params': expectedHeaderRequestParams,
    ...
    describe('listNodePools', () => {
        it('invokes listNodePools without error', async () => {
            ...
            request.zone = '';
            request.clusterId = '';
            const expectedHeaderRequestParams = "parent=&project_id=&zone=&cluster_id=";
            const expectedOptions = {
                otherArgs: {
                    headers: {
                        'x-goog-request-params': expectedHeaderRequestParams,
    ...
    describe('completeNodePoolUpgrade', () => {
        it('invokes completeNodePoolUpgrade without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.container.v1.CompleteNodePoolUpgradeRequest());
            request.name = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.completeNodePoolUpgrade as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
